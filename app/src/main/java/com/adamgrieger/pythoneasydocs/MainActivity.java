...
public class MainActivity extends AppCompatActivity {
    private static final int MANAGE_DOCS_ID = 1;

    private AccountHeader mAccountHeader = null;
    private Drawer mDrawer = null;
    public Intent startManageDocsActivityIntent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startManageDocsActivityIntent = new Intent(this, ManageDocsActivity.class);
        ...
        mAccountHeader = new AccountHeaderBuilder()
                ...
                .withOnAccountHeaderListener(new AccountHeader.OnAccountHeaderListener() {
                    ...
                    public boolean onProfileChanged(View view, IProfile profile, boolean current) {
                        if (profile instanceof IDrawerItem && profile.getIdentifier() == MANAGE_DOCS_ID) {
                            startActivity(startManageDocsActivityIntent);
                        }
